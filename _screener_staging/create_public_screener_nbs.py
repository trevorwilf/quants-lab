...
''',
        ...
        public_note="Default quote asset is `USDT`, but you can switch `QUOTE_ASSET` to `XMR`, `BTC`, or any other quote supported by NonKYC. The notebook uses the documented public REST endpoints for markets, tickers, order books, candles, and trades.",
        quote_asset="USDT",
        interval="5m",
        universe_top_k=80,
        final_top_n=25,
