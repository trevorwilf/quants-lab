...
def validate_finalist(
    *,
    ...
    generate_report(
        ...
        dataset_audit=audit, sensitivity_report=sens_report,
        recent_window_result=recent_window_result,
    ...
    json_data = {
        ...
        "dev_fee_drag_pct": dev_metrics.fee_drag_pct,
        "dev_max_drawdown_pct": dev_metrics.max_drawdown_pct,
        "wf_fold_count": len(wf_result.folds),
        "holdout_passed": holdout_report.exported_holdout_passed,
        "holdout_score": getattr(holdout_report, 'exported_holdout_score', None),
        "holdout_collapse": getattr(holdout_report, 'exported_holdout_collapse', None),
        "stress_worst": stress_report.worst_score if stress_report else None,
        "sensitivity_penalty": sensitivity_penalty,
        "recent_passed": getattr(recent_window_result, 'passed', None),
        "cluster_is_clustered": getattr(cluster_report, 'is_clustered', None),
        "dataset_audit_passed": getattr(audit, 'passed_strict', None),
        "parity_passed": getattr(parity_result, 'passed', None),
