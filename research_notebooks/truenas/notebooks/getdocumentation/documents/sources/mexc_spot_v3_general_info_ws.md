_Source: webscrape/mexc/mexc_spot_general_info.html (browser-rendered)_

_Loaded: 2026-04-04T04:30:29.907884Z_

General Info | MEXC API
...
* [English](/api-docs/spot-v3/general-info "English")
* [中文](/zh-MY/api-docs/spot-v3/general-info "中文")
...
Base endpoint[​](#base-endpoint "Direct link to Base endpoint")
---------------------------------------------------------------
...
HTTP Return Codes[​](#http-return-codes "Direct link to HTTP Return Codes")
---------------------------------------------------------------------------
...
General Information on Endpoints[​](#general-information-on-endpoints "Direct link to General Information on Endpoints")
------------------------------------------------------------------------------------------------------------------------
...
* Each endpoint with IP limits has an independent 300 every 10 second limit.
...
FAQs](/api-docs/spot-v3/faqs "PreviousFAQs")[Next

Market Data Endpoints](/api-docs/spot-v3/market-data-endpoints "NextMarket Data Endpoints")

* [Base endpoint](#base-endpoint "Base endpoint")
* [HTTP Return Codes](#http-return-codes "HTTP Return Codes")
* [General Information on Endpoints](#general-information-on-endpoints "General Information on Endpoints")
* [Header](#header "Header")
* [SIGNED](#signed "SIGNED")
  + [Timing security](#timing-security "Timing security")
  + [SIGNED Endpoint Examples for POST /api/v3/order](#signed-endpoint-examples-for-post-apiv3order "SIGNED Endpoint Examples for POST /api/v3/order")
  + [Timing security](#timing-security-1 "Timing security")
  + [SIGNED Endpoint Examples for POST /api/v3/order](#signed-endpoint-examples-for-post-apiv3order-1 "SIGNED Endpoint Examples for POST /api/v3/order")
* [LIMITS](#limits "LIMITS")
  + [Limits Description](#limits-description "Limits Description")
  + [Limits Error](#limits-error "Limits Error")
  + [Websocket Limits](#websocket-limits "Websocket Limits")
