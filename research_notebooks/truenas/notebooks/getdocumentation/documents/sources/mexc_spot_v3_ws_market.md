_Source: https://www.mexc.com/api-docs/spot-v3/websocket-market-streams_

_Fetched: 2026-04-04T04:30:15.530064Z_
...
* [English](/api-docs/spot-v3/websocket-market-streams)
* [中文](/zh-MY/api-docs/spot-v3/websocket-market-streams)
...
Wallet Endpoints](/api-docs/spot-v3/wallet-endpoints)[Next

Websocket User Data Streams](/api-docs/spot-v3/websocket-user-data-streams)

* [Live Subscription/Unsubscription to Data Streams](#live-subscriptionunsubscription-to-data-streams)
* [Protocol Buffers Integration](#protocol-buffers-integration)
  + [Subscribe to a Data Stream](#subscribe-to-a-data-stream)
  + [Unsubscribe from a Data Stream](#unsubscribe-from-a-data-stream)
  + [PING/PONG Mechanism](#pingpong-mechanism)
* [Trade Streams](#trade-streams)
* [K-line Streams](#k-line-streams)
* [Diff.Depth Stream](#diffdepth-stream)
...
* [Individual Symbol Book Ticker Streams(Batch Aggregation)](#individual-symbol-book-ticker-streamsbatch-aggregation)
