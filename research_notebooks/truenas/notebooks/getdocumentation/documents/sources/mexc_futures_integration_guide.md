_Source: https://www.mexc.com/api-docs/futures/integration-guide_

_Fetched: 2026-04-04T04:30:19.768560Z_

Integration Guide | MEXC API
...
Access URL[​](#access-url "Direct link to Access URL")
------------------------------------------------------
...
Common Response Structure[​](#common-response-structure "Direct link to Common Response Structure")
---------------------------------------------------------------------------------------------------
...
3. For private endpoints:
   ...
   * If the request source is OPEN-API, include the `ApiKey`, `Request-Time`, `Signature`, and `Revc-Window` (optional) parameters in the header. `Signature` is the signature string, with rules as follows:
...
You can click [here](https://www.mexc.la/ucenter/openapi "create API key") to create an API Key.
