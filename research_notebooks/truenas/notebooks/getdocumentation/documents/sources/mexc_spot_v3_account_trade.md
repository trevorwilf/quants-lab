_Source: https://www.mexc.com/api-docs/spot-v3/spot-account-trade_

_Fetched: 2026-04-04T04:30:13.947701Z_
...
* [English](/api-docs/spot-v3/spot-account-trade)
* [中文](/zh-MY/api-docs/spot-v3/spot-account-trade)
...
| --- | --- | --- | --- |
| symbol | STRING | YES |  |
| side | ENUM | YES | ENUM: [Order Side](/api-docs/spot-v3/public-api-definitions#order-side) |
| type | ENUM | YES | ENUM: [Order Type](/api-docs/spot-v3/public-api-definitions#order-type) |
...
| type | ENUM: [Order Type](/api-docs/spot-v3/public-api-definitions#order-type) |
| side | ENUM: [Order Side](/api-docs/spot-v3/public-api-definitions#order-side) |
...
3. For other self-trade issues, please refer to: [Introduction to Self-Trade Prevention](https://www.mexc.com/zh-MY/announcements/article/introduction-to-self-trade-prevention-stp-17827791526132);
...
| status | ENUM: [Order Status](/api-docs/spot-v3/public-api-definitions#order-status) |
| type | ENUM: [Order Type](/api-docs/spot-v3/public-api-definitions#order-type) |
| side | ENUM: [Order Side](/api-docs/spot-v3/public-api-definitions#order-side) |
...
Sub-Account Endpoints(Only supports main account API key)](/api-docs/spot-v3/subaccount-endpoints)[Next
...
* [Create STP strategy group](#create-stp-strategy-group)
* [Query STP strategy group](#query-stp-strategy-group)
* [Delete STP strategy group](#delete-stp-strategy-group)
* [Add uid to STP strategy group](#add-uid-to-stp-strategy-group)
* [Delete uid to STP strategy group](#delete-uid-to-stp-strategy-group)