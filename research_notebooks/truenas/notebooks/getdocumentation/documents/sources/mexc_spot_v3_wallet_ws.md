_Source: webscrape/mexc/mexc_spot_wallet_endpoints.html (browser-rendered)_

_Loaded: 2026-04-04T04:30:30.400482Z_

Wallet Endpoints | MEXC API
...
* [English](/api-docs/spot-v3/wallet-endpoints "English")
* [中文](/zh-MY/api-docs/spot-v3/wallet-endpoints "中文")
...
Query the currency information[​](#query-the-currency-information "Direct link to Query the currency information")
------------------------------------------------------------------------------------------------------------------
...
Withdraw(new)[​](#withdrawnew "Direct link to Withdraw(new)")
-------------------------------------------------------------
...
Cancel withdraw[​](#cancel-withdraw "Direct link to Cancel withdraw")
---------------------------------------------------------------------
...
Deposit History(supporting network)[​](#deposit-historysupporting-network "Direct link to Deposit History(supporting network)")
-------------------------------------------------------------------------------------------------------------------------------
...
| --- | --- | --- | --- |
| coin | string | NO | coin |
| status | string | NO | [deposit status](/api-docs/spot-v3/public-api-definitions#deposit_status "deposit status") |
...
| status | [deposit status](/api-docs/spot-v3/public-api-definitions#deposit_status "deposit status") |
...
Withdraw History (supporting network)[​](#withdraw-history-supporting-network "Direct link to Withdraw History (supporting network)")
-------------------------------------------------------------------------------------------------------------------------------------
...
| --- | --- | --- | --- |
| coin | string | NO | coin |
| status | string | NO | [withdraw status](/api-docs/spot-v3/public-api-definitions#withdraw_status "withdraw status") |
| limit | string | NO | default:1000, max:1000 |
| startTime | string | NO | default: 7 days ago from current time |
| endTime | string | NO | default:current time |
| timestamp | string | YES | timestamp |
...
| status | [withdraw status](/api-docs/spot-v3/public-api-definitions#withdraw_status "withdraw status") |
...
Generate deposit address (supporting network)[​](#generate-deposit-address-supporting-network "Direct link to Generate deposit address (supporting network)")
-------------------------------------------------------------------------------------------------------------------------------------------------------------
...
Deposit Address (supporting network)[​](#deposit-address-supporting-network "Direct link to Deposit Address (supporting network)")
----------------------------------------------------------------------------------------------------------------------------------
...
Withdraw Address (supporting network)[​](#withdraw-address-supporting-network "Direct link to Withdraw Address (supporting network)")
-------------------------------------------------------------------------------------------------------------------------------------
...
User Universal Transfer[​](#user-universal-transfer "Direct link to User Universal Transfer")
---------------------------------------------------------------------------------------------
...
Query User Universal Transfer History[​](#query-user-universal-transfer-history "Direct link to Query User Universal Transfer History")
---------------------------------------------------------------------------------------------------------------------------------------
...
Query User Universal Transfer History （by tranId）[​](#query-user-universal-transfer-history-by-tranid "Direct link to Query User Universal Transfer History （by tranId）")
-------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
Get Assets That Can Be Converted Into MX[​](#get-assets-that-can-be-converted-into-mx "Direct link to Get Assets That Can Be Converted Into MX")
------------------------------------------------------------------------------------------------------------------------------------------------
...
Dust Transfer[​](#dust-transfer "Direct link to Dust Transfer")
---------------------------------------------------------------
...
DustLog[​](#dustlog "Direct link to DustLog")
---------------------------------------------
...
Internal Transfer[​](#internal-transfer "Direct link to Internal Transfer")
---------------------------------------------------------------------------
...
Query Internal Transfer history[​](#query-internal-transfer-history "Direct link to Query Internal Transfer history")
---------------------------------------------------------------------------------------------------------------------
...
Withdraw(previous,offline soon)[​](#withdrawpreviousoffline-soon "Direct link to Withdraw(previous,offline soon)")
------------------------------------------------------------------------------------------------------------------
...
Spot Account/Trade](/api-docs/spot-v3/spot-account-trade "PreviousSpot Account/Trade")[Next

Websocket Market Streams](/api-docs/spot-v3/websocket-market-streams "NextWebsocket Market Streams")

* [Query the currency information](#query-the-currency-information "Query the currency information")
* [Withdraw(new)](#withdrawnew "Withdraw(new)")
* [Cancel withdraw](#cancel-withdraw "Cancel withdraw")
* [Deposit History(supporting network)](#deposit-historysupporting-network "Deposit History(supporting network)")
* [Withdraw History (supporting network)](#withdraw-history-supporting-network "Withdraw History (supporting network)")
* [Generate deposit address (supporting network)](#generate-deposit-address-supporting-network "Generate deposit address (supporting network)")
* [Deposit Address (supporting network)](#deposit-address-supporting-network "Deposit Address (supporting network)")
* [Withdraw Address (supporting network)](#withdraw-address-supporting-network "Withdraw Address (supporting network)")
* [User Universal Transfer](#user-universal-transfer "User Universal Transfer")
* [Query User Universal Transfer History](#query-user-universal-transfer-history "Query User Universal Transfer History")
* [Query User Universal Transfer History （by tranId）](#query-user-universal-transfer-history-by-tranid "Query User Universal Transfer History （by tranId）")
* [Get Assets That Can Be Converted Into MX](#get-assets-that-can-be-converted-into-mx "Get Assets That Can Be Converted Into MX")
* [Dust Transfer](#dust-transfer "Dust Transfer")
* [DustLog](#dustlog "DustLog")
* [Internal Transfer](#internal-transfer "Internal Transfer")
* [Query Internal Transfer history](#query-internal-transfer-history "Query Internal Transfer history")
* [Withdraw(previous,offline soon)](#withdrawpreviousoffline-soon "Withdraw(previous,offline soon)")
