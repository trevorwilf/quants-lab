...
| `take_profit_order_type` | `enum string (OrderType)` | no | LIMIT | Order type used when placing the take-profit exit order. Allowed values / format: OrderType enum. | `DirectionalTradingControllerConfigBase` | `hummingbot/strategy_v2/controllers/directional_trading_controller_base.py:78` |
...
| `take_profit_order_type` | `enum string (OrderType)` | no | LIMIT | Order type used when placing the take-profit exit order. Allowed values / format: OrderType enum. | `MarketMakingControllerConfigBase` | `hummingbot/strategy_v2/controllers/market_making_controller_base.py:99` |
